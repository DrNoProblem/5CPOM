    ...
    <div className="main p20 flex-col relative flex-end-align g25">
      <div className="flex-col g25 w100">
        ...
        <div className="flex-col big-dark-container display-from-left">
          <h2 className="m0">3PROJ :</h2>
          <div className="flex-wrap mt25 g25">
            <Link className="home-tile small-normal-container" to={"/1PROJ"}>
              <span className="ml15 mr15">Draw</span>
            </Link>
            <Link className="home-tile small-normal-container" to={"/1PROJ"}>
              <span className="ml15 mr15">Draw history</span>
            </Link>
            <div
              className="home-tile small-normal-container"
              onClick={() => setAddActive(!AddActive)}
            >
              <span className="ml15 mr15">Create room</span>
            </div>
          </div>
        </div>
        <div className="table-list flex-col p50 dark-bg big-dark-container display-from-left">
          ...
          <ul className="table-list flex-col mb0">
            ...
            {OwnerRoom
              ? OwnerRoom.map((room: RoomModel) =>
                  room.owner === currentUser._id ||
                  room.co_owner === currentUser._id ? (
              ...
              <div className="flex-col">
                ...
                {ReadyToSend ? (
                  <div
                    ...
                    onClick={() => AddNewRoom(objectFiledAddUser)}
                  >
                    <span>ADD THIS NEW USER</span>
                  </div>
                ) : (
